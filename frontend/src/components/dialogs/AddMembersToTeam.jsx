...
import NewTeamBody from "./NewTeamBody";
...
const AddMembersToTeam = ({ getAddedMembers, forCreateGroup }) => {
  ...
  const openNewGroupDialog = () => {
    ...
    setChildDialogBody(<NewTeamBody closeChildDialog={closeChildDialog} />);
    displayChildDialog({
